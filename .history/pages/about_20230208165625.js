        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.information}>
                    <div><p className={styles.paragraphs}>Ware proud to deliver an education that goes beyond textbooks and classrooms.</p></div>
                    ...
                    <div><h2 className={styles.subHeader}>Information Sessions</h2></div>
                    ...
                    <div><h3 className={styles.smallSubHeader}>Big Info</h3></div>
                    ...
                    <div><h2 className={styles.subHeader}>Campus Tours</h2></div>
