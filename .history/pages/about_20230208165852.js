        ...
        <>
            ...
            <main className={styles.main}>
                ...
                <div id="carouselImage" className={styles.carouselImage}>
                    <img className={styles.carousel} src={"public/carousel-images/0.jpg"} />
                    <img className={styles.carousel} src={"public/carousel-images/1.jpg"} />
                    <img className={styles.carousel} src={"public/carousel-images/2.jpg"} />
                    <img className={styles.carousel} src={"public/carousel-images/3.jpg"} />
                    <img className={styles.carousel} src={"public/carousel-images/4.jpg"} />
                    <img className={styles.carousel} src={"public/carousel-images/5.jpg"} />
                </div>
